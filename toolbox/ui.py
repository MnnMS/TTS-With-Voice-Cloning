...
default_text = \
    "Welcome to the toolbox! To begin, load an audio sample from your files or record one " \
...
class UI(QDialog):
    ...
    def __init__(self):
        ...
        super().__init__(None)
        self.setWindowTitle("TTS with Voice Cloning")
        ...
        browser_layout.addWidget(self.utterance_history, i, 1, 1, 4)
        i += 1

        # Random & next utterance buttons
        self.browser_browse_button = QPushButton("Browse")
        browser_layout.addWidget(self.browser_browse_button, i, 1)
        self.record_button = QPushButton("Record")
        browser_layout.addWidget(self.record_button, i, 2)
        self.play_button = QPushButton("Play")
        browser_layout.addWidget(self.play_button, i, 3)
        self.stop_button = QPushButton("Stop")
        browser_layout.addWidget(self.stop_button, i, 4)
        i += 1

        # Model and audio output selection
        self.audio_out_devices_cb=QComboBox()
        browser_layout.addWidget(QLabel("<b>Audio Output</b>"), i, 0)
        browser_layout.addWidget(self.audio_out_devices_cb, i, 1)
